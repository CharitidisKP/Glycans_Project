...
Comparators <- c("AI", "CI", "S_creatinine", "eGFR", "UPCR", "albumin", "Extra_Renal", "Renal_Impairment", "Clinical")
...
Main_plot <- ggplot(Correlations, aes(x = Variable, y = Marker, fill = Correlation)) +
  ...
  scale_x_discrete(labels = function(x) {
    x <- gsub("_", " ", x)
    x <- gsub("Renal_Extra", "Renal<br>Extra", x)
    x <- gsub("Renal_Impairment", "Renal<br>Impairment", x)
    x }, expand = c(0,0)) +
