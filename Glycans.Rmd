...
# ggsave(Combined_Plot, filename = "~/SLE/Glycans/Plots/Glycans_Correlations_2.jpeg", width = 10, height = 16, dpi = 300)
...
plot_summs(Multi_Models$AGP_Clinical, 
           Multi_Models$AGP_Renal_Impairment, 
           exp = TRUE, 
           model.names = c("AGP_Clinical", "AGP_Renal_Impairment"))
...
for (i in unique(Multi_Results$Origin)) {
  ...
  Current_Plot <- plot_summs(Model_1, 
                             Model_2,
                             exp = TRUE, 
                             model.names = c(Current_Model_1, Current_Model_2)) +
    labs(x = "Odds Ratio",
         y = "Predictor",
         title = paste0("OR comparison: ", i)) +
