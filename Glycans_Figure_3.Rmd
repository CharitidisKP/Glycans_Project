...
Main_plot_current_combined <- ggplot(NIH_Corr_Res_Sign_only_Clean, aes(x = Result, y = Marker, fill = Correlation)) +
    geom_tile(color = "white", width = 1, height = 1) +
    scale_fill_gradient2(low = "dodgerblue", mid = "white", high = "firebrick", 
                         midpoint = 0, breaks = seq(-1, 1, by = 0.5), 
                         guide = guide_colorbar(order = 1, title.position = "top", title.hjust = 0, 
  ...
  ggsave(Main_plot_current_combined,
       filename = paste0("~/SLE/Glycans/Plots_2/Figure_3_Correlations_NIH/Correlations_NIH_Combined.jpeg"),
       width = 20,
       height = 25,
       dpi = 300)
