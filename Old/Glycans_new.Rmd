...
```{r Figure 3 Visualisation}

Histology_Heatmap <- ggplot(NIH_plot_data, aes(x = Result, y = Marker, fill = Spearman_estimate)) +
  geom_tile(color = "white", width = 1, height = 1) +
  scale_fill_gradient2(low = "dodgerblue", mid = "white", high = "firebrick", 
                       midpoint = 0, breaks = seq(-1, 1, by = 0.5), 
                       guide = guide_colorbar(order = 1, title.position = "top", title.hjust = 0, 
  ...
  labs(title = "Heatmap of Marker - Histology correlations", x = NULL, y = NULL, 
...
ggsave(plot = Histology_Heatmap, filename = "~/Downloads/Histology_Heatmap.jpeg", 
       device = "jpeg", width = 18, height = 20, dpi = 300)
