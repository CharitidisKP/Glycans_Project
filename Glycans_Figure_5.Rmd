...
plot_GLM_results_final <- function(Dataframe_GLM, Method, Double_Sign_Markers) {
  ...
  Label_df <- if (Method == "T0") {
    DF_Plot %>% filter(Significance == "Significant")
  } else {
    DF_Plot %>% filter(Highlight == "Significant in both<br>response types")
  }
...
# ggsave(filename = "~/SLE/Glycans/Plots_2/Figure_5_GLMs/Firth_BM12Delta_A4.jpeg",
